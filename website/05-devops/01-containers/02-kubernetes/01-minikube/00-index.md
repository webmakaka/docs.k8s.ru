...
[Инсталляция kubectl ubuntu 20.04.1](//kuberops.ru/containers/kubernetes/tools/kubectl/)

[Инсталляция и подготовка minikube для работы в ubuntu 20.04.1](//kuberops.ru//containers/kubernetes/minikube/setup/)
