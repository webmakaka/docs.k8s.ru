...
[Инсталляция kubectl ubuntu 20.04.1](/tools/containers/kubernetes/tools/kubectl/)

[Инсталляция и подготовка minikube для работы в ubuntu 20.04.1](/tools/containers/kubernetes/minikube/setup/)
